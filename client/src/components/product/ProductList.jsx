...
const ProductList = () => {
  ...
  const products = isFetched ? data.slice((currentPage - 1) * productsPerPage, currentPage * productsPerPage) : [];
    ...
    <div className="h-full flex flex-col justify-between">
      ...
      <div className="flex justify-center p-4">
        ...
        <button
          ...
          className={`px-4 py-2 rounded ${
            currentPage === totalPages ? "bg-red-300 text-white" : "bg-slate-500 text-white hover:bg-slate-600"
          }`}
        >
          Next
        </button>
